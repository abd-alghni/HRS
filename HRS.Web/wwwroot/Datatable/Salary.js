        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            columns: [{
                ...
                template: function (data) {
                    return '\<a  href ="/Salary/Update/' + data.id + '" class="PopUp btn btn-sm btn-clean btn-icon mr-2" title="تعديل  بيانات ' + data.id + ' ">\
                        ...
                        <a href ="/Salary/Delete/' + data.id + '" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Delete">\
