    ...
    var demo = function () {
            ...
            columns: [
                ...
                autoHide: false,
                    template: function (data) {
                        var buttons = '';
                        buttons = buttons + '';
                        buttons = buttons + '\<a  href ="/Holiday/Update/' + data.id + '" class="PopUp btn btn-sm btn-clean btn-icon mr-2" title="تعديل  بيانات ' + data.id + ' ">\
                        ...
                        <a href ="/Holiday/Delete/' + data.id + '" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Delete">\
                            ...
                            <a title="Changes Log" class="PopUp btn btn-sm btn-clean btn-icon mr-2" href="/Holiday/GetLog/' + data.id + '">\
        ...
        <path d="M12,15 C10.3431458,15 9,13.6568542 9,12 C9,10.3431458 10.3431458,9 12,9 C13.6568542,9 15,10.3431458 15,12 C15,13.6568542 13.6568542,15 12,15 Z" fill="#000000" opacity="0.3"/>\
                        ...
                        if (data.status == 'Pending') {
                            buttons = buttons +'<a href="/Holiday/UpdateStatus/' + data.id + '?status=3" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="رفض" >\
                            ...
                            <a href="/Holiday/UpdateStatus/' + data.id + '?status=2" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="موافقة" >\
                            ...
                            buttons = buttons +'<a href="/Holiday/UpdateStatus/' + data.id + '?status=2" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="موافقة" >\
                                <span class="svg-icon svg-icon-success svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Code/Done-circle.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                    <g stroke="none" stroke - width="1" fill = "none" fill - rule="evenodd" >\
                                    <rect x="0" y="0" width="24" height="24" />\
                                    <circle fill="#000000" opacity="0.3" cx="12" cy="12" r="10" />\
